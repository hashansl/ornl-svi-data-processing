    ...
    if len(generalized_variance_dic)==1:
        ...
        for key in component_census.keys():
            ...
            if len(pdgms) > 0:
                ...
                pimgs = pimgr.transform(pdgms)
                pimgs = np.rot90(pimgs, k=1) #comment if ploting images
...
if __name__ == "__main__":
    ...
    data_path = "/home/h6x/git_projects/ornl-svi-data-processing/processed_data/SVI/2020/SVI2020_NOT_SCALED_MISSING_REMOVED"
    base_path = "/home/h6x/git_projects/ornl-svi-data-processing/experiment_6/processed_data_1/npy_all_variables"
