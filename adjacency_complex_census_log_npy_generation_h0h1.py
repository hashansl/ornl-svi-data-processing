    ...
    for county_stcnty in unique_county_stcnty:
        ...
        for variable_name in selected_variables:
            ...
            for birth, death in intervals_dim0:
                if death < np.inf:
                    if birth == 0:
                        pdgms.append([np.log(epsilon), np.log(death)])
                    else:
                        pdgms.append([np.log(birth), np.log(death)])
...
if __name__ == "__main__":
    # Main execution
    base_path = '/home/h6x/git_projects/data_processing/processed_data/adjacency_pers_images_npy_county/experimet_5/npy_all_variables'
