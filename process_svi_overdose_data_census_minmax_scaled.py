...
def load_data(svi_path, overdose_path):
    ...
    # add a column as gnn_id and set it from zero to len(us_svi)
    us_svi['gnn_id'] = range(len(us_svi))
...
def main():
    svi_path = '/home/h6x/git_projects/data_processing/raw_data/svi/2018/SVI2018_US_tract.gdb'
    overdose_path = '/home/h6x/Projects/overdose_modeling/data/HepVu_County_Opioid_Indicators_05DEC22.xlsx'
    output_dir = '/home/h6x/git_projects/data_processing/processed_data/SVI/SVI2018_MIN_MAX_SCALED_MISSING_REMOVED_GNN_ID'
