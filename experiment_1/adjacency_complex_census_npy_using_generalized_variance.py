...
def generate_persistence_images(simplices, df_one_variable, variable_name, county_stcnty, base_path, PERSISTENCE_IMAGE_PARAMS, generalized_variance_dic, component_census, component_simplices):
    ...
    if len(generalized_variance_dic)==1:
        ...
        if len(pdgms) > 0:
            ...
            #new code -------------------------
            print(f"pimager shape :",pimgs_.shape)
        ...
        # print the shape of the final_pimgr

        print(f"Final pimager shape :",final_pimgr.shape)
...
if __name__ == "__main__":
    ...
    base_path = "/home/h6x/git_projects/ornl-svi-data-processing/experiment_1/processed_data_1/comparison"
